...
const instance = axios.create({
  baseURL: "https://adidas-api.crud.uz/",
  headers: {
...
export function branches() {
  return instance.get("get_branches");
}
export function branch(id) {
  return instance.get("get_branch/" + id);
}
export function createBranch(data) {
  return instance.post(`create_branch`, data);
}
export function updateBranch(data) {
  return instance.put(`update_branch/${data.id}`, data);
}
export function createLogo(data, image) {
  return instance.post(`create_logo/${data.id}`, image);
}
export function removeLogo(id) {
  return instance.delete(`remove_logo/${id}`);
}

// users

export function thisUser(id) {
  return instance.get(`this_user/${id}`);
}
...
export function users(id, page, limit) {
  return instance.get(
    `get_users/?branch_id=${id}&?page=${page}&limit=${limit}`
  );
}
...
export function customer(id) {
  return instance.get(`this_customer/${id}`);
}
export function customers(page, limit, search) {
  if (search) {
    ...
    return instance.get(`get_customers?page=${page}&limit=${limit}`);
  }
}
export function createCustomer(data) {
  return instance.post("customer_create", data);
}
export function updateCustomer(data) {
  return instance.put("update_customer/" + data.id, data);
}

// loan

export function loan(id) {
  return instance.get(`get_customer_loan/${id}`);
}
export function orderLoan(order_id, loan_id) {
  return instance.get(`get_loan?order_id=${order_id}&loan_id=${loan_id}`);
}
...
export function takeLoan(id, price, type) {
  return instance.post(`take_loan/${id}?money=${price}&type=${type}`);
}
...
export function incomes(id, status, page, limit) {
  return instance.get(
    `get_incomes/${id}/${status}?page=${page}&limit=${limit}`
  );
}
...
export function market(id) {
  return instance.get(`this_market/${id}`);
}
export function markets(page, limit) {
  return instance.get("get_markets?page=" + page + "&limit=" + limit);
}
export function createMarket(data) {
  return instance.post("create_market", data);
}
export function updateMarket(data) {
  return instance.put("update_market/" + data.id, data);
}
export function takeIncomeFromMarket(data) {
  return instance.post(`take_income_from_market`, data);
}
export function marketBalance(id) {
  return instance.get(`market_sum_price/${id}`);
}

// warehouse

export function warehouse(id) {
  return instance.get(`this_warehouse/${id}`);
}
export function warehouses() {
  return instance.get("get_warehouses");
}

export function createWarehouse(data) {
  return instance.post("create_warehouse", data);
}

export function updateWarehouse(data) {
  return instance.put("update_warehouse/" + data.id, data);
}
export function warehouseBalances(id) {
  return instance.get(`warehouse_products_sum_price/${id}`);
}
...
export function removeWarehouseProduct(product_id, quantity) {
  return instance.delete(`remove_w_product/${product_id}/${quantity}`);
}
...
export function transferProduct(id, data) {
  return instance.post(`transfer_product/${id}`, data);
}
export function removeTransfer(transfer_id) {
  return instance.delete(`remove_transfer/${transfer_id}`);
}
export function acceptTransfer(id, data) {
  return instance.post(`acceptance_product/${id}`, data);
}

// currency

export function currencies() {
  return instance.get("get_currencies");
}
export function createCurrency(data) {
  return instance.post(`create_currency`, data);
}
export function updateCurrency(data) {
  return instance.put("update_currency/" + data.id, data);
}
...
export function createCategory(data) {
  return instance.post("create_category", data);
}
export function updateCategory(data) {
  return instance.put("update_category/" + data.id, data);
}
...
export function addProducts(data) {
  return instance.post(`add_product`, data);
}
export function updateProduct(code, size, data) {
  return instance.put(`update_product/${code}/${size}`, data);
}
...
export function productsSumPrice() {
  return instance.get(`products_sum_price`);
}

// control

export function createControl() {
  return instance.post(`create_control`);
}
export function removeControl() {
  return instance.delete(`remove_control`);
}
...
export function updateControlProduct(data) {
  return instance.put(`update_product_control`, {
    code: data.code,
...
export function photo(articul) {
  return instance.get(`get_photos/${articul}`);
}
export function uploadPhoto(articul, file) {
  return instance.post(`upload_photo/${articul}`, file);
}
export function removePhoto(articul, id) {
  return instance.delete(`remove_photo/${articul}/${id}`);
}

// order

export function order(id) {
  return instance.get(`get_this_order/${id}`);
}
...
export function createOrder() {
  return instance.post(`create_order`);
}
export function removeOrder(id) {
  return instance.delete(`remove_order/${id}`);
}
export function confirmationOrder(id, data) {
  return instance.put(`order_confirmation/${id}`, data);
}
...
export function updateTrade(status, data) {
  return instance.put(`update_trade/${status}`, data);
}
export function tradeBalance(id) {
  return instance.get(`get_trade_balance/${id}`);
}
...
export function returnProduct(id, data) {
  return instance.put(`return_product/${id}`, data);
}
...
export function parties(status, page, limit) {
  return instance.get(
    `get_parties?status=${status}&page=${page}&limit=${limit}`
  );
}
export function createParty() {
  return instance.post("create_party");
}
...
export function partyBalances(id) {
  return instance.get(`get_party_balances/${id}`);
}
...
export function takeSupply(data) {
  return instance.post("take_supply", data);
}
...
export function partyExpenses(id, page, limit) {
  return instance.get(`get_party_expenses/${id}?page=${page}&limit=${limit}`);
}
export function marketExpenses(id, page, limit, from_time, to_time) {
  if (from_time && to_time) {
    ...
    return instance.get(
      `get_market_expenses/${id}?page=${page}&limit=${limit}`
    );
  }
}
...
export function payForPartyExpense(data) {
  return instance.post(`pay_for_party_expense/`, data);
}
export function payForMarketExpense(data) {
  return instance.post(`pay_for_market_expense`, data);
}
export function payForUser(data) {
  return instance.post(`pay_to_user`, data);
}
...
export function payForAdmin(data) {
  return instance.post(`pay_to_admin`, data);
}
...
export function distribute() {
  return instance.get(`get_orders_for_distributed_profit`);
}
export function postDistribute() {
  return instance.post(`profit_sharing`);
}
export function distributeHistory(date, page, limit) {
  if (date) {
    ...
    return instance.get(`get_distributed_profit?page=${page}&limit=${limit}`);
  }
}
